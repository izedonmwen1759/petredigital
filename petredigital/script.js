...
socket.on('posts',(data)=>{
    ...
    for (let i = 0; i < data.length; i++) {     
       ht += '<div class="col-lg-4 "><div class="card bg-transparent m-1 border border-primary colored_card" style="width:22rem;"><img src="'+data[i].image+'" class="card-img-top img-responsive"/><div class=""><h3>'+data[i].text+'</h3></div><a class="btn btn-sm btn-primary text-white" href="'+data[i].url+'" target="_blank" onclick="countCLick(\''+data[i].id+'\')">Click Here</a></div></div>'
    }
